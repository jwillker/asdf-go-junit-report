...
# NOTE: You might want to remove this if go-junit-report is not hosted on GitHub releases.
...
list_all_versions() {
  ...
  # Change this function if go-junit-report has other means of determining installable versions.
  list_github_tags
}
